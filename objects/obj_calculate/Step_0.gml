...
trx = tr.tr1 + tr.tr2 + tr.tr3 + tr.tr4 +tr.tr5 + tr.tr6 + tr.tr7 +tr.tr8 + tr.tr9;

if(!global.tr375)
{
global.tr_end = (trx / 10) *1.1;

global.tr_end = ceil(global.tr_end) /2 ;
}

else

{
global.stairrail = (trx / 10) *1.1;

global.stairrail = ceil(global.tr_end) /2 ;
...
for (i = 9; i > 0; i = i -1)
{
if variable_instance_get(tr , "tr" + string(i)) > 0
{
 c[i]= c_lime;
}
else
...
{
case vk_numpad1:
tr.tr1 = get_integer("enter top rail length",tr.tr1);
break;
case vk_numpad2:
tr.tr2 = get_integer("enter top rail length",tr.tr2);
break;
case vk_numpad3:
tr.tr3 = get_integer("enter top rail length",tr.tr3);
break;
case vk_numpad4:
tr.tr4 = get_integer("enter top rail length",tr.tr4);
break;
case vk_numpad5:
tr.tr5 = get_integer("enter top rail length",tr.tr5);
break;
case vk_numpad6:
tr.tr6 = get_integer("enter top rail length",tr.tr6);
break;
case vk_numpad7:
tr.tr7 = get_integer("enter top rail length",tr.tr7);
break;
case vk_numpad8:
tr.tr8 = get_integer("enter top rail length",tr.tr8);
break;
case vk_numpad9:
tr.tr9 = get_integer("enter top rail length",tr.tr9);
break;
case vk_numpad0:
